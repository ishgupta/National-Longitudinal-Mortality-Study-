...
##### Impute marital status w.r.t Age

```{r}
table(suicides_11$age, suicides_11$ms)
...
suicides_11$ms <- as.integer(suicides_11$ms)

```

##### Impute hispanic by place of Birth
```{r}

unique(suicides_11$hisp)
...
rm(list = c("pob_hisp_1", "pob_hisp_2", "pob_hisp_3"))

suicides_11$hisp <- as.integer(suicides_11$hisp)
